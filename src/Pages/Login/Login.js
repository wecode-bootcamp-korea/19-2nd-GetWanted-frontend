...
import getwanted from './images/getwanted.jpg';

const Login = () => {
  return (
    <LoginWrapper>
      <ModalHeader>
        <img alt="로고이미지" src={getwanted}></img>
      </ModalHeader>
      <ModalBody>
        <h1>
          직장인을 위한
...
const Form = styled.div`
  ...
  input {
    ...
    padding-left: 15px;
    margin 20px 0;
    border: 1px solid ${theme.grayBtn};
    border-radius: 5px;
    fon-size: 15px;
...
const Button = styled.button`
  ...
  border: none;
  border-radius: 27px;
  background-color: ${props => (props.bgColor ? props.bgColor : '#36f')};
